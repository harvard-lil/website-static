...
## Katie Mackinnon
Another area that I am working on is software preservation. I am looking not at efforts to prevent software from dying, but what it means for software to "end." There are so many projects where software is totally abandoned, where it can't be repaired and it's just sort of left out to end.

I think that these endings are actually fine, and also worth noticing because there are so many different reasons why software ends. It's not just about the code not being operable, but all these other factors. It invites us to think about the afterlives of these systems where it's not really about preserving what it was, but rather thinking of it more ecologically. What networks did it sit within? What social relationships were influenced by its presence?
