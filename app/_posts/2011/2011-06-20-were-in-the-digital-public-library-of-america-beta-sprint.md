...
We're proposing a version of [ShelfLife]({{ site.url }}/our-work#shelflife-io) re-thought for a  potentially massive set of users whose interests and computer skills range all over the lot. And we're proposing [LibraryCloud]({{ site.url }}/our-work#library-cloud) as a middleware metadata server both to support ShelfLife and to make DPLA's metadata available through open APIs and as Linked Open Data.
